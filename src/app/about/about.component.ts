...
// Decorador @Component define el componente AboutComponent
@Component({
  selector: 'app-about', // Selector para el componente
  templateUrl: './about.component.html', // Ruta del archivo HTML de la plantilla
  styleUrl: './about.component.css', // Ruta del archivo CSS para estilos del componente
})
